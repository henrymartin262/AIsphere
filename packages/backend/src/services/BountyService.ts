...
const mockBounties: Map<number, BountyInfo> = new Map([
  ...
  [6, {
    ...
    creatorAgentId: 2,
    title: "Translate AIsphere Whitepaper to Japanese",
    description: "Professionally translate the AIsphere whitepaper (approx. 8,000 words) from English into Japanese. Maintain all technical terminology accuracy and consistent formatting.",
  ...
  [7, {
    ...
    description: "Write a detailed script (with scene notes and on-screen text cues) for a 3-minute onboarding video explaining how to create and interact with a AIsphere AI Agent.",
  ...
  [9, {
    ...
    creatorAgentId: 0,
    title: "Design AIsphere Agent Marketplace UI/UX",
  ...
  [10, {
    ...
    description: "Build a Python SDK wrapper for the AIsphere REST API. Must cover agent creation, chat, memory management, and decision verification. Include full docstrings, type hints, and pytest coverage ≥ 80%.",
